...
const PAGE_TEMPLATE = {
  ...
  sections: [
    ...
    { id: 'rc7', name: 'Warriors Partnership Promo', selector: '#main-content > div.sc-f9eaaf5f-0.cwMKbe > section.sc-3cb30ae3-10.jDUkDo:nth-of-type(7)', style: null, blocks: ['columns'], defaultContent: [] },
    ...
    { id: 'rc10', name: 'Gartner Report Promo', selector: '#gartner', style: null, blocks: ['columns'], defaultContent: [] },
